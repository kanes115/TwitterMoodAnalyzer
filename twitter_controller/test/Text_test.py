...
class TextTest(unittest.TestCase):
    def external_links_test(self):
        t = Text('This is a little content', links=['https://twitter.com',
    ...
    def add_test(self):
        ...
        res1 = t + p
        res2 = Text(t.content + p.content, hashtags=(set(t.hashtags + p.hashtags)), links=(t.links + p.links))
        self.assertEqual(res1.get_content(), res2.get_content())
        self.assertEqual(res1.get_external_links(), res2.get_external_links())
        self.assertEqual(str(res1.get_external_links()), str(res2.get_external_links()))
